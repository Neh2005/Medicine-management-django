...
urlpatterns = [
    ...
    #path('login/', RedirectView.as_view(url='/home/')),  # Redirect to 'home' URL
    path('products/',include('products.urls')),
    path('pagevisit/',views.pagevisit,name='page_visit'),
    path('signup/',views.signup_page,name='signup'),
    path('login/',views.login_page,name='login'), 
    path('logout/', views.logout_view,name='logout'),
    path('medicalproductsapi/', include('medicalproductsapi.urls')),
    path('productsajax/', include('productsajax.urls')),
